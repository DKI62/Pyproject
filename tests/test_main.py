import json
import pytest
from src.utilts import mask_card_number, mask_account_number, format_date, format_operation, get_last_operations
...
def mock_data(tmpdir):
    ...
    data = [
        {"date": "2024-06-10T08:30:00", "description": "Payment", "from": "Visa 1234567890123456", "to": "1234567890",
        ...
        {"date": "2024-06-08T15:45:00", "description": "Purchase", "from": "Maestro 9876987698769876",
         "to": "0987654321",
